...
set_property PACKAGE_PIN U9 [get_ports {nextcolor[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {nextcolor[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {nextcolor[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {nextcolor[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {nextcolor[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {nextcolor[2]}]
...
set_property PACKAGE_PIN R10 [get_ports nextpb]						
	set_property IOSTANDARD LVCMOS33 [get_ports nextpb]
...
set_property PACKAGE_PIN B13 [get_ports {r1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {r1}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {g1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {g1}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports {b1}]					
